...
const file_v1_recommendationService_proto_rawDesc = "" +
	"\n" +
	"\x1ev1/recommendationService.proto\x12\x11recommendation.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"H\n" +
	...
	"\x04side\x18\x02 \x01(\tR\x04side2\x84\x05\n" +
	...
	"\x14DeleteParsingChannel\x12..recommendation.v1.DeleteParsingChannelRequest\x1a/.recommendation.v1.DeleteParsingChannelResponseB\x13Z\x11recommendation/v1b\x06proto3"
...
var file_v1_recommendationService_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_v1_recommendationService_proto_goTypes = []any{
	(*DeleteParsingChannelRequest)(nil),     // 0: recommendation.v1.DeleteParsingChannelRequest
	(*DeleteParsingChannelResponse)(nil),    // 1: recommendation.v1.DeleteParsingChannelResponse
	(*AddNewParsingChannelRequest)(nil),     // 2: recommendation.v1.AddNewParsingChannelRequest
	(*AddNewParsingChannelResponse)(nil),    // 3: recommendation.v1.AddNewParsingChannelResponse
	(*GetAllParsingChannelsRequest)(nil),    // 4: recommendation.v1.GetAllParsingChannelsRequest
	(*GetAllParsingChannelsResponse)(nil),   // 5: recommendation.v1.GetAllParsingChannelsResponse
	(*GetRecommendatedPostsRequest)(nil),    // 6: recommendation.v1.GetRecommendatedPostsRequest
	(*GetRecommendatedPostsResponse)(nil),   // 7: recommendation.v1.GetRecommendatedPostsResponse
	(*GetUserPriorityChannelsRequest)(nil),  // 8: recommendation.v1.GetUserPriorityChannelsRequest
	(*GetUserPriorityChannelsResponse)(nil), // 9: recommendation.v1.GetUserPriorityChannelsResponse
	(*Cursor)(nil),                          // 10: recommendation.v1.Cursor
	(*Post)(nil),                            // 11: recommendation.v1.Post
	(*Stock)(nil),                           // 12: recommendation.v1.Stock
	(*timestamppb.Timestamp)(nil),           // 13: google.protobuf.Timestamp
}
var file_v1_recommendationService_proto_depIdxs = []int32{
	10, // 0: recommendation.v1.GetRecommendatedPostsRequest.cursor:type_name -> recommendation.v1.Cursor
	11, // 1: recommendation.v1.GetRecommendatedPostsResponse.posts:type_name -> recommendation.v1.Post
	10, // 2: recommendation.v1.GetRecommendatedPostsResponse.next_cursor:type_name -> recommendation.v1.Cursor
	12, // 3: recommendation.v1.Post.stocks:type_name -> recommendation.v1.Stock
	13, // 4: recommendation.v1.Post.date:type_name -> google.protobuf.Timestamp
	8,  // 5: recommendation.v1.RecommendationService.GetUserPriorityChannels:input_type -> recommendation.v1.GetUserPriorityChannelsRequest
	6,  // 6: recommendation.v1.RecommendationService.GetRecommendatedPosts:input_type -> recommendation.v1.GetRecommendatedPostsRequest
	4,  // 7: recommendation.v1.RecommendationService.GetAllParsingChannels:input_type -> recommendation.v1.GetAllParsingChannelsRequest
	2,  // 8: recommendation.v1.RecommendationService.AddNewParsingChannel:input_type -> recommendation.v1.AddNewParsingChannelRequest
	0,  // 9: recommendation.v1.RecommendationService.DeleteParsingChannel:input_type -> recommendation.v1.DeleteParsingChannelRequest
	9,  // 10: recommendation.v1.RecommendationService.GetUserPriorityChannels:output_type -> recommendation.v1.GetUserPriorityChannelsResponse
	7,  // 11: recommendation.v1.RecommendationService.GetRecommendatedPosts:output_type -> recommendation.v1.GetRecommendatedPostsResponse
	5,  // 12: recommendation.v1.RecommendationService.GetAllParsingChannels:output_type -> recommendation.v1.GetAllParsingChannelsResponse
	3,  // 13: recommendation.v1.RecommendationService.AddNewParsingChannel:output_type -> recommendation.v1.AddNewParsingChannelResponse
	1,  // 14: recommendation.v1.RecommendationService.DeleteParsingChannel:output_type -> recommendation.v1.DeleteParsingChannelResponse

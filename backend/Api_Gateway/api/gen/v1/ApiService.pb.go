...
const file_v1_ApiService_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x13.api.v1.ChannelListR\x05value:\x028\x01\"H\n" +
	...
	"\tusernames\x18\x01 \x03(\tR\tusernames2\xd7\n" +
	"\n" +
	"\n" +
	"ApiService\x12J\n" +
	...
	"#GetAllParsingChannelsWithCategories\x122.api.v1.GetAllParsingChannelsWithCategoriesRequest\x1a3.api.v1.GetAllParsingChannelsWithCategoriesResponse\"4\x82\xd3\xe4\x93\x02.\x12,/v1/get_all_parsing_channels_with_categoriesB\x13Z\x11api/v1/ApiServiceb\x06proto3"
...
var file_v1_ApiService_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_v1_ApiService_proto_goTypes = []any{
	(*GetAllParsingChannelsWithCategoriesRequest)(nil),  // 0: api.v1.GetAllParsingChannelsWithCategoriesRequest
	(*GetAllParsingChannelsWithCategoriesResponse)(nil), // 1: api.v1.GetAllParsingChannelsWithCategoriesResponse
	(*AddNewParsingChannelRequest)(nil),                 // 2: api.v1.AddNewParsingChannelRequest
	(*AddNewParsingChannelResponse)(nil),                // 3: api.v1.AddNewParsingChannelResponse
	(*DeleteParsingChannelRequest)(nil),                 // 4: api.v1.DeleteParsingChannelRequest
	(*DeleteParsingChannelResponse)(nil),                // 5: api.v1.DeleteParsingChannelResponse
	(*GetAllParsingChannelsRequest)(nil),                // 6: api.v1.GetAllParsingChannelsRequest
	(*GetUserPriorityChannelsRequest)(nil),              // 7: api.v1.GetUserPriorityChannelsRequest
	(*GetUserPriorityChannelsResponse)(nil),             // 8: api.v1.GetUserPriorityChannelsResponse
	(*GetAllParsingChannelsResponse)(nil),               // 9: api.v1.GetAllParsingChannelsResponse
	(*DeletePriorityChannelRequest)(nil),                // 10: api.v1.DeletePriorityChannelRequest
	(*DeletePriorityChannelResponse)(nil),               // 11: api.v1.DeletePriorityChannelResponse
	(*GetRecommendatedPostsRequest)(nil),                // 12: api.v1.GetRecommendatedPostsRequest
	(*GetRecommendatedPostsResponse)(nil),               // 13: api.v1.GetRecommendatedPostsResponse
	(*SetPriorityChannelsRequest)(nil),                  // 14: api.v1.SetPriorityChannelsRequest
	(*SetPriorityChannelsResponse)(nil),                 // 15: api.v1.SetPriorityChannelsResponse
	(*LoginRequest)(nil),                                // 16: api.v1.LoginRequest
	(*LoginResponse)(nil),                               // 17: api.v1.LoginResponse
	(*IsAdminRequest)(nil),                              // 18: api.v1.IsAdminRequest
	(*IsAdminResponse)(nil),                             // 19: api.v1.IsAdminResponse
	(*Post)(nil),                                        // 20: api.v1.Post
	(*Stock)(nil),                                       // 21: api.v1.Stock
	(*Cursor)(nil),                                      // 22: api.v1.Cursor
	(*ChannelList)(nil),                                 // 23: api.v1.ChannelList
	nil,                                                 // 24: api.v1.GetAllParsingChannelsWithCategoriesResponse.ChannelsEntry
	(*timestamppb.Timestamp)(nil),                       // 25: google.protobuf.Timestamp
}
var file_v1_ApiService_proto_depIdxs = []int32{
	24, // 0: api.v1.GetAllParsingChannelsWithCategoriesResponse.channels:type_name -> api.v1.GetAllParsingChannelsWithCategoriesResponse.ChannelsEntry
	22, // 1: api.v1.GetRecommendatedPostsRequest.cursor:type_name -> api.v1.Cursor
	20, // 2: api.v1.GetRecommendatedPostsResponse.posts:type_name -> api.v1.Post
	22, // 3: api.v1.GetRecommendatedPostsResponse.next_cursor:type_name -> api.v1.Cursor
	21, // 4: api.v1.Post.stocks:type_name -> api.v1.Stock
	25, // 5: api.v1.Post.date:type_name -> google.protobuf.Timestamp
	23, // 6: api.v1.GetAllParsingChannelsWithCategoriesResponse.ChannelsEntry.value:type_name -> api.v1.ChannelList
	16, // 7: api.v1.ApiService.Login:input_type -> api.v1.LoginRequest
	18, // 8: api.v1.ApiService.IsAdmin:input_type -> api.v1.IsAdminRequest
	14, // 9: api.v1.ApiService.SetPriorityChannels:input_type -> api.v1.SetPriorityChannelsRequest
	12, // 10: api.v1.ApiService.GetRecommendatedPosts:input_type -> api.v1.GetRecommendatedPostsRequest
	7,  // 11: api.v1.ApiService.GetUserPriorityChannels:input_type -> api.v1.GetUserPriorityChannelsRequest
	10, // 12: api.v1.ApiService.DeletePriorityChannels:input_type -> api.v1.DeletePriorityChannelRequest
	6,  // 13: api.v1.ApiService.GetAllParsingChannels:input_type -> api.v1.GetAllParsingChannelsRequest
	2,  // 14: api.v1.ApiService.AddNewParsingChannel:input_type -> api.v1.AddNewParsingChannelRequest
	4,  // 15: api.v1.ApiService.DeleteParsingChannel:input_type -> api.v1.DeleteParsingChannelRequest
	0,  // 16: api.v1.ApiService.GetAllParsingChannelsWithCategories:input_type -> api.v1.GetAllParsingChannelsWithCategoriesRequest
	17, // 17: api.v1.ApiService.Login:output_type -> api.v1.LoginResponse
	19, // 18: api.v1.ApiService.IsAdmin:output_type -> api.v1.IsAdminResponse
	15, // 19: api.v1.ApiService.SetPriorityChannels:output_type -> api.v1.SetPriorityChannelsResponse
	13, // 20: api.v1.ApiService.GetRecommendatedPosts:output_type -> api.v1.GetRecommendatedPostsResponse
	8,  // 21: api.v1.ApiService.GetUserPriorityChannels:output_type -> api.v1.GetUserPriorityChannelsResponse
	11, // 22: api.v1.ApiService.DeletePriorityChannels:output_type -> api.v1.DeletePriorityChannelResponse
	9,  // 23: api.v1.ApiService.GetAllParsingChannels:output_type -> api.v1.GetAllParsingChannelsResponse
	3,  // 24: api.v1.ApiService.AddNewParsingChannel:output_type -> api.v1.AddNewParsingChannelResponse
	5,  // 25: api.v1.ApiService.DeleteParsingChannel:output_type -> api.v1.DeleteParsingChannelResponse
	1,  // 26: api.v1.ApiService.GetAllParsingChannelsWithCategories:output_type -> api.v1.GetAllParsingChannelsWithCategoriesResponse

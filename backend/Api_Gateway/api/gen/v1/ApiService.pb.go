...
const file_v1_ApiService_proto_rawDesc = "" +
	...
	"\x15GetRecommendatedPosts\x12$.api.v1.GetRecommendatedPostsRequest\x1a%.api.v1.GetRecommendatedPostsResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v1/get_recommendated_postsB\x13Z\x11api/v1/ApiServiceb\x06proto3"
...
var file_v1_ApiService_proto_goTypes = []any{
	...
	(*SetPriorityChannelsRequest)(nil),    // 2: api.v1.SetPriorityChannelsRequest
	(*SetPriorityChannelsResponse)(nil),   // 3: api.v1.SetPriorityChannelsResponse
	(*LoginRequest)(nil),                  // 4: api.v1.LoginRequest
	(*LoginResponse)(nil),                 // 5: api.v1.LoginResponse
	(*IsAdminRequest)(nil),                // 6: api.v1.IsAdminRequest

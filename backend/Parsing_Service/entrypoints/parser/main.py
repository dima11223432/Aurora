"""Main entry point for the Telegram Parser Service.

Loads configuration, initializes database and application,
and starts the asynchronous Telegram monitoring loop.
"""
